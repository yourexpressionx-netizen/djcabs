  ...
  return (
    <div className="my-8 px-4">
            ...
            return (
              ...
              >
                <div className={styles.instagramPost}>
                  {imageUrl ? (
                    <>
                      {/* Using HTML img instead of Next Image for video thumbnails */}
                      <img
                        src={imageUrl}
                        alt="Instagram post"
                        ...
                        onError={(e) => {
                          ...
                          target.src = 'data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22100%22 height=%22100%22%3E%3Crect fill=%22%23e5e7eb%22 width=%22100%22 height=%22100%22/%3E%3Ctext x=%2250%22 y=%2250%22 text-anchor=%22middle%22 dy=%22.3em%22 fill=%22%239ca3af%22 font-size=%2214%22%3EError%3C/text%3E%3C/svg%3E';
                        }}
                      />
      ...
      <div className="text-center">
        <a
          href="https://www.instagram.com/darjeelingcabs/"
          target="_blank"
          rel="noopener noreferrer"
